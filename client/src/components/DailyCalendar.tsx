...
const DAILY_QUOTES = [
  ...
  "You don't need to be a tech expert to use AI. Just be curious.",
  ...
  "The women who thrive will be the ones who made AI their partner.",
  "AI gives you your time back. What you do with it is entirely up to you.",
  "You don't need to understand how AI works. Just understand how it can work for you.",
  ...
  "Every hour AI saves is an hour you can spend on what only you can do.",
  ...
  "Use AI where it saves time. Show up with your heart where it counts.",
  ...
  "There's a version of you on the other side of this you can't yet imagine.",
