...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* WHAT AI CAN BUILD - Advanced Showcase Section */}
      <div className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-16 bg-gradient-to-b from-white via-purple-50 to-white overflow-hidden">
        {/* Background animated elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
            className="absolute top-10 right-10 w-64 h-64 bg-gradient-to-br from-purple-300 to-purple-200 rounded-full blur-3xl opacity-10"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
            className="absolute bottom-20 left-10 w-72 h-72 bg-gradient-to-tr from-purple-400 to-purple-300 rounded-full blur-3xl opacity-5"
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-5xl md:text-6xl font-black text-black mb-6">What AI Can Actually Build</h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              This isn't theory. These are real apps, real businesses, real income streams built by women using the exact tools you'll learn. This is what's possible when you understand how to work WITH AI instead of competing against it.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {[
              {
                title: "Personalized AI Meal Planner",
                desc: "Generates custom meal plans based on dietary preferences, budget, allergies. Saves 5 hours weekly. Woman charges $27/month, 200 subscribers = $5,400 MRR.",
                features: ["Auto-generates recipes", "Grocery list creation", "Nutrition tracking", "Passive income"],
                gradient: "from-pink-500 to-purple-500"
              },
              {
                title: "AI Content Creation Tool",
                desc: "Turns YouTube videos into TikToks, Reels, LinkedIn posts automatically. Saves 15+ hours weekly. Sold to 500+ creators who pay $29/month.",
                features: ["1-click conversion", "Multi-platform export", "Caption generation", "$14.5K MRR"],
                gradient: "from-blue-500 to-cyan-500"
              },
              {
                title: "AI Resume Optimizer",
                desc: "Analyzes job descriptions, rewrites resume for ATS optimization. Gets interviews. Woman charges $47 per resume, sells 200/month = $9,400 MRR.",
                features: ["ATS optimization", "Keyword matching", "Format perfection", "Job matching"],
                gradient: "from-green-500 to-emerald-500"
              },
              {
                title: "AI Kids' Story Generator",
                desc: "Creates personalized bedtime stories featuring the child. Parents love it. Sold 1,000+ subscriptions at $9.99/month = $10K MRR.",
                features: ["Personalized stories", "Illustration ready", "Multiple genres", "Parent favorites"],
              ...
              >
                ...
                {/* Card content */}
                <div className="relative z-10 p-8 bg-white border-2 border-purple-200 rounded-2xl hover:shadow-2xl transition-all">
                  <motion.div
                    animate={{ y: [0, -5, 0] }}
                    transition={{ duration: 3, repeat: Infinity, delay: i * 0.2 }}
                    className="mb-6"
                  >
                    <h3 className="text-2xl font-bold text-black mb-2 group-hover:text-purple-600 transition-colors">{app.title}</h3>
                  ...
                  <div className="space-y-2">
                    {app.features.map((feature, j) => (
                      ...
                      >
                        <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${app.gradient}`} />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-black text-white p-12 rounded-2xl text-center"
          >
            <p className="text-2xl font-bold mb-4">The women making $5-15K MRR aren't genius programmers.</p>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              They're strategic thinkers who understand problem-solving. They learned how to use AI to build solutions people want. They're not "tech people"—they're business people who learned to code better WITH AI than most engineers could do manually.
            </p>
          </motion.div>
          ...
          >
            <p className="text-gray-700 mb-6 text-lg font-medium">Your app idea is waiting. Learn how to build it.</p>
            <Button 
              onClick={handleSignup}
              className="bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white font-bold uppercase tracking-wider px-10 py-4 rounded-lg text-lg shadow-xl hover:shadow-2xl transition-all"
              data-testid="button-build-app-cta"
            >
