  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full h-full min-h-screen flex flex-col items-center justify-center relative z-10"
      >
        <div className="w-full h-full flex flex-col items-center justify-center px-6 py-12 sm:px-12 sm:py-16 md:px-20 md:py-20">
