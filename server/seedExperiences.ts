...
export const EXPERIENCES: InsertTransformationalExperience[] = [
  ...
  // Brief stubs for remaining spaces to reach 69 experiences
  {
    ...
    content: {
      sections: [
        { id: "s1", title: "AI as Your Time Multiplier", type: "text", content: "As a mother building a business, your most scarce resource is time. AI doesn't add hours to your day, but it compresses the work that fills them. Tasks that used to take an hour (writing emails, planning content, researching competitors) now take ten minutes. The shift isn't about working harder; it's about delegating the repetitive cognitive work to an AI assistant so you can focus on the decisions only you can make. Think of AI as the team member who never sleeps, never needs a sick day, and never judges you for working at 11pm after bedtime." },
        { id: "s2", title: "The 30-Minute Power Block", type: "text", content: "The reality of building while parenting is that you rarely get four uninterrupted hours. You get thirty-minute pockets: during nap time, after school drop-off, before the house wakes up. AI makes those pockets powerful. In thirty minutes with an AI assistant, you can draft a week of social media captions, outline a blog post, write three client emails, and generate a meeting agenda. The key is having your prompts ready before you sit down. Prepare a list of recurring tasks with saved prompt templates so when you get your window, you execute immediately instead of thinking about what to do." },
        { id: "s3", title: "Setting Boundaries Without Guilt", type: "text", content: "The guilt of choosing work over family time (or family over work) is real. AI helps reduce that tension by making your work time dramatically more productive, which means you need less of it. Set clear boundaries: work hours are work hours, family hours are family hours. Use AI to batch your content creation into one focused session per week instead of scrambling daily. Automate your email responses, schedule your social posts, and let AI handle the first drafts. When you close your laptop, you're actually done, not carrying mental to-do lists into dinner time." },
        { id: "s4", title: "Building Systems That Run Without You", type: "interactive", content: "Map out your weekly business tasks and identify which ones AI can handle. Start with these categories: content creation (AI writes first drafts), client communication (AI drafts responses you review), research (AI summarizes industry news), and administrative work (AI organizes, schedules, formats). For each task, write one prompt template you can reuse every week. The goal is a system where Monday morning you sit down, run your prompts, review the outputs, and have your entire week's content and communications ready by lunchtime. Test this system for one week and measure how much time you save." },
        { id: "s5", title: "Your Motherhood-Business Integration Plan", type: "hands_on_lab", content: "Create your personalized integration plan. Step 1: Write down your available time blocks for the next week (be honest, include nap times, school hours, early mornings). Step 2: List your top 5 recurring business tasks and write an AI prompt template for each one. Step 3: Assign each task to a specific time block. Step 4: Run the plan for one full week. Step 5: At the end of the week, document what worked and what didn't. Adjust the prompts that gave weak results and move time blocks that didn't fit. After two weeks of iteration, you'll have a sustainable system that respects both your business ambitions and your family priorities." }
      ]
    },
    personalizationEnabled: false
  },

  {
    ...
    content: {
      sections: [
        { id: "s1", title: "You Don't Need to Code", type: "text", content: "The biggest myth in tech is that you need to know how to code to build an app. In 2026, AI-powered platforms like Replit, Bolt, and Lovable let you describe what you want in plain language and generate a working application. You type 'build me a client booking system with a calendar and payment integration' and get a functional app in minutes, not months. This isn't a toy or a prototype. These are real, deployable applications that handle real users and real transactions. The skill you need isn't programming. It's clarity: knowing exactly what you want your app to do and being able to describe it precisely." },
        { id: "s2", title: "Choosing Your Building Tool", type: "text", content: "Three platforms stand out for building without code. Replit is the most powerful: it generates full-stack applications with databases, user authentication, and payment processing. Best for complex apps you want full control over. Bolt.new is fastest for web apps: describe your idea and get a working React application in minutes. Best for landing pages, dashboards, and simple tools. Framer is ideal for marketing websites: beautiful, responsive, and optimized for conversion without touching code. Choose based on what you're building: Replit for apps with user accounts and data, Bolt for quick web tools, Framer for websites that need to look stunning." },
        { id: "s3", title: "Writing Clear App Descriptions", type: "text", content: "The quality of what AI builds depends entirely on how well you describe it. A vague prompt like 'build me a business app' produces generic results. A specific brief like 'build a client intake form that collects name, email, service type (dropdown: coaching, consulting, VIP day), preferred date, and budget range, saves submissions to a database, and sends me an email notification for each new submission' produces exactly what you need. Before you open any building tool, write a one-page brief: what the app does, who uses it, what data it collects, and what happens after they submit. This document is your prompt." },
        { id: "s4", title: "Building and Testing Your App", type: "interactive", content: "Pick one simple app idea from this list and build it right now using Replit or Bolt: a client testimonial collector (form with name, photo upload, testimonial text, star rating), a service price calculator (inputs for service type and hours, outputs total with your rates), or a lead magnet delivery page (email capture, sends a PDF link). Open your chosen platform, paste your description, and let the AI generate it. Test every button and form field. Find what's broken and ask the AI to fix it by describing the problem in plain language. Most fixes take one sentence: 'the submit button doesn't clear the form after submission' or 'add a confirmation message after the form is sent.'" },
        { id: "s5", title: "Ship Your First App This Week", type: "hands_on_lab", content: "Your assignment: build and deploy a real app for your business by the end of this week. Step 1: Pick the simplest tool your business needs (a booking form, a resource library, a price quote calculator). Step 2: Write a one-paragraph description of exactly what it does. Step 3: Build it in Replit or Bolt. Step 4: Test it yourself and fix any issues. Step 5: Deploy it (both platforms offer one-click deployment). Step 6: Share the link with one real person and ask them to use it. Step 7: Document their feedback and make one improvement. You now have a live app that serves your business. Most people talk about building apps for months. You just did it in days." }
      ]
    },
    personalizationEnabled: false
  },

  {
    ...
    content: {
      sections: [
        { id: "s1", title: "From Idea to Validated Offer", type: "text", content: "Most founders spend months perfecting their product before asking a single person to pay for it. That's backwards. Validation comes before building. Use AI to accelerate the validation process: describe your idea to an AI assistant and ask it to poke holes in it, identify your ideal customer, and list the top three objections that customer would have. Then go talk to five real people who fit that profile. Don't pitch them. Ask: 'What's your biggest frustration with [the problem you solve]?' and 'If something could fix that, what would it need to do?' Their answers shape your offer more than any business plan." },
        { id: "s2", title: "Building Your Minimum Viable Offer", type: "text", content: "Your first offer doesn't need a website, a logo, or a funnel. It needs three things: a clear transformation promise, a price, and a way for someone to pay you. The transformation promise is one sentence: 'I help [who] achieve [result] in [timeframe] through [method].' Use AI to draft ten versions and pick the one that feels most true and most compelling. The price should feel uncomfortable but not impossible. If your first offer is too cheap, you attract price-sensitive clients who drain your energy. Start at a price that makes you slightly nervous. That's usually the right number." },
        { id: "s3", title: "Getting Your First Three Clients", type: "text", content: "Your first clients don't come from ads, funnels, or viral content. They come from direct conversations with people who already trust you. Write a list of thirty people in your network who either need what you offer or know someone who does. Use AI to draft a personal, non-salesy message to each one: 'I'm launching something new and thought of you. I'm helping [who] with [result]. Do you know anyone who might be interested?' This isn't cold outreach. It's warm activation. Three clients from thirty conversations is a 10% conversion rate, which is realistic and achievable in your first two weeks." },
        { id: "s4", title: "Revenue Systems That Scale", type: "interactive", content: "Once you have paying clients, systematize the delivery so it doesn't consume all your time. Map your client delivery process from start to finish: onboarding, service delivery, check-ins, off-boarding. Identify which steps can be templated (use AI to create the templates) and which steps require you personally. For example, your onboarding questionnaire can be an AI-generated form. Your follow-up emails can be AI-drafted and personalized. Your session prep can be AI-assisted research. Document your entire process, then time each step. Find the bottleneck. Automate or delegate that step first." },
        { id: "s5", title: "Your 12-Week Launch Plan", type: "hands_on_lab", content: "Build your launch timeline. Weeks 1-2: Validate your idea (5 customer conversations, AI-assisted offer refinement). Weeks 3-4: Package your offer (pricing, description, payment method, simple landing page built with AI). Weeks 5-6: Activate your network (30 personal messages, first 1-3 clients). Weeks 7-8: Deliver and collect feedback (serve your first clients, document results). Weeks 9-10: Optimize and systematize (build templates, automate onboarding, refine your process). Weeks 11-12: Scale outreach (content strategy, testimonials from first clients, raise prices for next cohort). Write down one specific action for each week. Pin it above your desk. Execute one week at a time." }
      ]
    },
    personalizationEnabled: false
  },
  ...
  // Placeholder for last digital-boutique experience to complete structure
  {
    ...
    content: {
      sections: [
        { id: "s1", title: "Choosing What to Sell Online", type: "text", content: "The best online stores don't sell everything. They sell one category of products exceptionally well to a specific audience. Before you pick a platform, decide what you're selling and to whom. Use AI to research your niche: 'What products are trending in [your category] for [your target audience]? What price range works? Who are the top 5 competitors and what do they do well?' The answers give you a market map. Your advantage as a solopreneur isn't price or selection. It's curation, story, and personal connection. You're not competing with Amazon. You're competing for the customer who wants to buy from a woman who shares her values." },
        { id: "s2", title: "Setting Up Your Store in One Day", type: "text", content: "Shopify is the fastest path to a live store. Create an account, choose a clean theme (don't overthink the design), and focus on three things: your homepage headline (what you sell and why it matters), your product pages (clear photos, compelling descriptions, honest pricing), and your checkout flow (simple, trustworthy, no surprises). Use AI to write every product description: 'Write a product description for [product] targeting [audience]. Highlight the benefit, not just the features. Tone: warm and sophisticated, not salesy. Under 100 words.' You can have a functional store live by end of day if you stop perfecting and start publishing." },
        { id: "s3", title: "AI-Powered Product Marketing", type: "text", content: "Marketing an online store is about showing up consistently where your customers already spend time. Use AI to build your marketing engine: generate a month of Instagram captions featuring your products, write email sequences for new subscribers (welcome, value, soft sell, direct offer), create blog posts targeting search queries your customers type (like 'best gifts for [your niche]'). The key is consistency, not virality. One post per day, one email per week, one blog post per month. AI makes this sustainable by handling the first drafts. You add your personality, your photos, and your authentic voice." },
        { id: "s4", title: "Driving Your First Sales", type: "interactive", content: "Your first ten sales set the foundation for everything that follows. Start with warm traffic: share your store link with your personal network, post on your social media accounts, email your existing contacts. Then build outward: collaborate with one complementary brand for a cross-promotion, offer a limited launch discount (create urgency with a real deadline), and ask every customer for a review and a referral. Track where each sale comes from. After ten sales, you'll know which channel works best for your audience. Double down on that channel and reduce effort on the others." },
        { id: "s5", title: "Launch Your Store This Week", type: "hands_on_lab", content: "Day 1: Create your Shopify account and choose a theme. Write your homepage headline and 'About' page with AI assistance. Day 2: Add your first 5 products with AI-written descriptions and your best photos (phone photos with good lighting work fine). Day 3: Set up payment processing (Stripe or Shopify Payments), shipping rates, and your return policy (use AI to draft it). Day 4: Create your Instagram shop link, write 5 launch posts with AI, and draft a launch email to your contacts. Day 5: Go live. Share everywhere. Ask three friends to be your first customers and leave reviews. Your store is now open for business. Celebrate, then start marketing consistently." }
      ]
    },
    personalizationEnabled: false
  },
