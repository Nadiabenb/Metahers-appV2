...
const METAHERS_VOYAGES = [
  // AI MASTERY VOYAGES (4)
  {
    ...
    description: "Set sail on Newport Bay as we demystify artificial intelligence together. Learn how to use ChatGPT, Claude, and other AI tools to 10x your productivity. By sunset, you'll have created your first AI workflows and feel like an AI native. Perfect for beginners who want to understand what's possible.",
    shortDescription: "Master AI fundamentals on a luxury Duffy boat cruise around Newport Bay.",
  ...
  },
  {
    ...
    maxCapacity: 6,
    currentBookings: 5,
    location: "The Deck on Laguna Beach",
    latitude: "33.5427",
    longitude: "-117.7854",
    learningObjectives: [
  ...
  },
  {
    ...
    category: "AI" as const,
    venueType: "Duffy_Boat" as const,
    description: "Ready for the next level? Learn to build your own custom GPTs, AI agents, and automated workflows. This advanced voyage is for women who've mastered the basics and want to become AI power users. Create tools your team will use daily.",
    shortDescription: "Build custom AI tools and agents on an exclusive Duffy boat experience.",
    ...
    maxCapacity: 6,
    currentBookings: 1,
    location: "Balboa Island Ferry Terminal",
    latitude: "33.6075",
    longitude: "-117.8989",
    learningObjectives: [
  ...
  // CRYPTO VOYAGES (3)
  {
    ...
    maxCapacity: 6,
    currentBookings: 4,
    location: "A Restaurant, Newport Beach",
    latitude: "33.6189",
    longitude: "-117.9289",
    learningObjectives: [
  ...
  },
  {
    ...
    category: "Crypto" as const,
    venueType: "Duffy_Boat" as const,
    description: "Go beyond holding crypto—learn to make it work for you. Explore DeFi protocols, staking, and yield farming in an intimate setting. Understand the risks and rewards, and set up your first passive income streams.",
    shortDescription: "Unlock DeFi and passive crypto income on a Newport Bay cruise.",
  ...
  // WEB3 VOYAGES (2)
  {
    ...
    maxCapacity: 6,
    currentBookings: 3,
    location: "Farmhouse at Roger's Gardens",
    latitude: "33.6137",
    longitude: "-117.8756",
    learningObjectives: [
  ...
  },
  {
    ...
    category: "Web3" as const,
    venueType: "Duffy_Boat" as const,
    description: "From idea to launch. This hands-on voyage helps you conceptualize and start building your Web3 project—whether it's an NFT collection, community, or decentralized app. Leave with a clear roadmap and the skills to execute.",
    shortDescription: "Launch your Web3 project during an inspiring boat journey.",
  ...
  },
  {
    ...
    maxCapacity: 6,
    currentBookings: 2,
    location: "Bluebird Canyon Cafe, Laguna Beach",
    latitude: "33.5293",
    longitude: "-117.7850",
    learningObjectives: [
  ...
  },
  {
    ...
    category: "AI_Branding" as const,
    venueType: "Duffy_Boat" as const,
    description: "Position yourself as the go-to expert in your niche. Learn to use AI for thought leadership content, speaking topics, and media opportunities. This voyage is for ambitious women ready to amplify their influence.",
    shortDescription: "Build your authority and thought leadership on a sunset cruise.",
