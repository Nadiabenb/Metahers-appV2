...
export const PRICING_PLANS: Record<SubscriptionTier, PricingPlan> = {
  ...
  signature_monthly: {
    ...
    description: 'A monthly AI implementation space for women founders who want prompts, agents, tools, guided learning, and optional Kids Learning for their family.',
    ...
    features: [
      ...
      'AI Toolkit',
      'Prompt Studio with curated packs',
  ...
  ai_blueprint: {
    ...
    features: [
      ...
      'Custom Prompt Studio for your business',
